...
***** ***** ***** ***** ***** ***** ***** *****
*                                               *
*  Building Amundsen frontend staging image...  *
*  This can take a bit of time with no cache.   *
*  The image is large.                          *
*                                               *
***** ***** ***** ***** ***** ***** ***** *****
EOF
...
tag="$registry/amundsen-frontend-staging:${image_version}"
latest_tag="$registry/amundsen-frontend-staging:latest"
...
echo "***** restarting frontend staging service... *****"
AWS_PROFILE=databricks-superadmin awsenv kubectl rollout restart deployment amundsen-frontendstaging

cat << EOF
***** ***** ***** ***** ***** ***** *****
*                                       *
*   Frontend Staging service restarted. *
