...
from dagster._core.execution.context.system import ExecutionData, StepExecutionContext
from dagster._core.execution.plan.step import ExecutionStep
from datamodel.resources.deltalake_io_managers import DeltaTableIOManager
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "us__datamodel_dev__t3",
            ["2024-01-01", "2024-02-01"],
            MonthlyPartitionsDefinition(start_date="2024-01-01"),
            {
                "write_mode": "merge",
                "schema": SCHEMA_1,
                "primary_keys": ["date", "org_id"],
            ...
            [
                ...
                {"org_id": 4, "date": "2024-01-01", "region": "eu-west-1"},
                {"org_id": 100, "date": "2024-01-01", "region": "eu-west-1"},
                {"org_id": 1, "date": "2024-02-01", "region": "us-west-2"},
                {"org_id": 2, "date": "2024-02-01", "region": "us-west-2"},
                {"org_id": 3, "date": "2024-02-01", "region": "eu-west-1"},
                {"org_id": 4, "date": "2024-02-01", "region": "eu-west-1"},
            ],
            ["date"],
        ...
        pytest.param(
            ...
            [
                ...
                {"org_id": 2, "date": "2024-01-01", "region": "us-west-2"},
                {"org_id": 100, "date": "2024-01-01", "region": "eu-west-1"},
                {"org_id": 100, "date": "2024-02-01", "region": "eu-west-1"},
            ],
            [
                {"org_id": 1, "date": "2024-01-01", "region": "eu-west-1"},
                {"org_id": 2, "date": "2024-01-01", "region": "us-west-2"},
        ...
        pytest.param(
            ...
            [
                "2024-01-01|eu-west-1",
                "2024-01-01|us-west-2",
                "2024-02-01|eu-west-1",
                "2024-02-01|us-west-2",
            ],
            MultiPartitionsDefinition(
                {
                    "date": MonthlyPartitionsDefinition(start_date="2024-01-01"),
                    "region": StaticPartitionsDefinition(["eu-west-1", "us-west-2"]),
                }
            ),
            {
        ...
        pytest.param(
            ...
            [
                {"org_id": 100, "date": "2024-01-01", "country": "usa"},
                {"org_id": 100, "date": "2024-01-01", "country": "canada"},
                {"org_id": 3, "date": "2024-01-01", "country": "usa"},
                {"org_id": 4, "date": "2024-01-01", "country": "canada"},
            ],
            [
                {"org_id": 100, "date": "2024-01-01", "country": "usa"},
                ...
                {"org_id": 3, "date": "2024-01-01", "country": "usa"},
                {"org_id": 4, "date": "2024-01-01", "country": "canada"},
                {"org_id": 1, "date": "2024-02-01", "country": "usa"},
                {"org_id": 2, "date": "2024-02-01", "country": "usa"},
                {"org_id": 3, "date": "2024-02-01", "country": "canada"},
                {"org_id": 4, "date": "2024-02-01", "country": "canada"},
            ],
            ["date", "country"],
