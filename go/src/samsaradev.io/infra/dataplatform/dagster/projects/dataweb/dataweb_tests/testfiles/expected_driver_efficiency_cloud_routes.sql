...
WHERE
cr.routename IN (
'fleet_driver_efficiency_profile_bounds', 'fleet_driver_efficiency_profile', 'fleet_driver_efficiency_assign_vehicles', 'fleet_driver_efficiency_profile_weights', 'driver_efficiency', 'driver_efficiency_weights', 'driver_efficiency_bounds', 'driver_efficiency_profile', 'driver_efficiency_assign_vehicles', 'driver_efficiency_profile_weights', 'driver_efficiency_profile_bounds'
