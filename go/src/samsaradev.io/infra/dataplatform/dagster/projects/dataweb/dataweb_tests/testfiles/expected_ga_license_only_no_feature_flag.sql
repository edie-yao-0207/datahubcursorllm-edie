...
AND (
fo.product_sku IN ('LIC-VG-ENT', 'LIC-VG-ENT-PLTFM-ESS', 'LIC-VG-ENT-PLTFM-PREM', 'LIC-VG-ENTERPRISE', 'LIC-VG-EXPRESS', 'LIC-VG-LD', 'LIC-VG-NOELD', 'LIC-VG-PREM-PLTFM-ESS', 'LIC-VG-PREM-PLTFM-PREM', 'LIC-VG-PS')
)
UNION ALL
SELECT DISTINCT o.org_id, fo.product_sku AS sku, xref.is_legacy_license
FROM edw.silver.fct_license_orders_daily_snapshot fo
