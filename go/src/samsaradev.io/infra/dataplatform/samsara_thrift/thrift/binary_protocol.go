...
func (p *TBinaryProtocol) ReadMessageBegin() (name string, typeId TMessageType, seqId int32, err error) {
	...
	if size < 0 {
		...
		if version != VERSION_1 {
			return name, typeId, seqId, NewTProtocolExceptionWithType(BAD_VERSION, errors.New("Bad version in ReadMessageBegin"))
		}
		name, e = p.ReadString()
		if e != nil {
	...
	if p.strictRead {
		return name, typeId, seqId, NewTProtocolExceptionWithType(BAD_VERSION, errors.New("Missing version in ReadMessageBegin"))
	}
