...
var GrowthDatabases = []SamsaraDB{ // lint: +sorted
	{
		Name:          "growth",
		...
		CanReadBiztechGroups: map[string][]string{
			...
			"bt-mda-analytics":            {infraconsts.SamsaraAWSDefaultRegion, infraconsts.SamsaraAWSEURegion, infraconsts.SamsaraAWSCARegion},
