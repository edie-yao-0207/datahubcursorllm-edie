...
S3_PREFIX = (
    "/Volumes/s3/databricks-workspace/platformalertsworkflows/soze_immobilizer_count"
)
REGION = boto3.session.Session().region_name

DAYS_LIMIT = 1  # Past 1 day
...
log_datadog_metrics(
    [
        {
            "metric": "databricks.platformalertsworkflows.immobilizerevents.count",
            "points": events_count,
            "tags": [f"region:{REGION}"],
        },
        {
            "metric": "databricks.platformalertsworkflows.immobilizerevents.done",
            "points": done_count,
            "tags": [f"region:{REGION}"],
        },
        {
            "metric": "databricks.platformalertsworkflows.immobilizerevents.ignored",
            "points": ignored_count,
            "tags": [f"region:{REGION}"],
        },
        {
            "metric": "databricks.platformalertsworkflows.immobilizerevents.failed",
            "points": failed_count,
            "tags": [f"region:{REGION}"],
        },
    ]
