...
def send_diff_metrics_to_channel(
    ...
    send_slack_message_to_channels_with_blocks("", channels, blocks)
...
params = CostParams(
    ...
    notebook_link="https://github.com/samsara-dev/backend/blob/master/dataplatform/notebooks/mem/service_costs_monthly.py",
)
