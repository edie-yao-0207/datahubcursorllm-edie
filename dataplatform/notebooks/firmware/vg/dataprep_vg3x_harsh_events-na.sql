...
--Grab harsh VG related harsh events
CREATE OR REPLACE TEMP VIEW harsh_events_labeled AS (
  ...
  WHERE a.harsh_accel_type IN (1,2,3,4,5)
)
...
CREATE TABLE IF NOT EXISTS data_analytics.dataprep_vg3x_harsh_events USING DELTA
...
USING dataprep_vg3x_harsh_events_updates AS updates ON
