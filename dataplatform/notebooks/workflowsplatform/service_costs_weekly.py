...
params = CostParams(
    ...
    slack_channels=["alerts-workflows-platform"],
    cost_allocations=['"COGS"'],
    metrics_types=["markdown"],
    notebook_link="https://github.com/samsara-dev/backend/blob/master/dataplatform/notebooks/workflowsplatform/service_costs_weekly.py",
)
