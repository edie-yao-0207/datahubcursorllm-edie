...
"""
The customer_ways_analysis notebook only handles one region at a time. This wrapper
will run that notebook for multiple regions in parallel!
"""

customer_ways_analysis_notebook = (
    "/backend/safety/speed_limits/analysis/customer_ways_analysis"
)
params = []
...
results = submit_parallel_notebook_runs(customer_ways_analysis_notebook, params)
print(results)
