...
select
  a.date,
  avg(a.recording_uptime) as avg,
  percentile_approx(a.recording_uptime, 0.5) as median,
  percentile_approx(a.recording_uptime, 0.4) as p40,
  percentile_approx(a.recording_uptime, 0.3) as p30,
  percentile_approx(a.recording_uptime, 0.2) as p20,
  percentile_approx(a.recording_uptime, 0.1) as p10,
  percentile_approx(a.recording_uptime, 0.09) as p09,
  percentile_approx(a.recording_uptime, 0.08) as p08,
  percentile_approx(a.recording_uptime, 0.07) as p07,
  percentile_approx(a.recording_uptime, 0.06) as p06,
  percentile_approx(a.recording_uptime, 0.05) as p05,
  percentile_approx(a.recording_uptime, 0.04) as p04,
  percentile_approx(a.recording_uptime, 0.03) as p03,
  percentile_approx(a.recording_uptime, 0.02) as p02,
  percentile_approx(a.recording_uptime, 0.01) as p01,
  percentile_approx(a.recording_uptime, 0.001) as p001
