...
select
  a.date,
  percentile_approx(dashcam_connected_ms/total_ms, 0.5) as median,
  percentile_approx(dashcam_connected_ms/total_ms, 0.1) as p10,
  percentile_approx(dashcam_connected_ms/total_ms, 0.01) as p1,
  percentile_approx(dashcam_connected_ms/total_ms, 0.001) as p01
from dataprep_firmware.cm_device_daily_dashcam_vg_connection as a
