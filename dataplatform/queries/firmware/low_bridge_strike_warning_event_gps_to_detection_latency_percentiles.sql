...
create or replace temp view gps_to_detection_latency as (
  select
    *,
    event_ms - gps_utc_ms as gps_to_detection_latency_ms
  from
...
select
  b.date,
  mean(gps_to_detection_latency_ms) as avg,
  percentile_approx(gps_to_detection_latency_ms, 0.5) as median,
  percentile_approx(gps_to_detection_latency_ms, 0.75) as p75,
  percentile_approx(gps_to_detection_latency_ms, 0.90) as p90,
  percentile_approx(gps_to_detection_latency_ms, 0.99) as p99
from
  gps_to_detection_latency as a
