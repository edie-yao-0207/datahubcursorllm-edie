...
select
	a.date,
	a.day_phase,
	percentile_approx(a.success_rate, 0.5) as median,
    percentile_approx(a.success_rate, 0.001) as p01,
	percentile_approx(a.success_rate, 0.01) as p1,
	percentile_approx(a.success_rate, 0.1) as p10
