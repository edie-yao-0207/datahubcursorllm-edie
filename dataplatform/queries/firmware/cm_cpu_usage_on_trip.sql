...
select
  a.date,
  percentile_approx(a.avg_cpu_usage_on_trip, 0.5) as median,
  percentile_approx(a.avg_cpu_usage_on_trip, 0.9) as p90,
  percentile_approx(a.avg_cpu_usage_on_trip, 0.99) as p99,
  percentile_approx(a.avg_cpu_usage_on_trip, 0.999) as p999
from dataprep_firmware.cm_device_daily_avg_cpu_usage_on_trip as a
