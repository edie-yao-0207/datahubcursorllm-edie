...
select
	a.date,
	day_phase,
	percentile_approx(duration_ms / (60 * 1000), 0.5) as median,
  percentile_approx(duration_ms / (60 * 1000), 0.90) as p90,
	percentile_approx(duration_ms / (60 * 1000), 0.99) as p99,
	percentile_approx(duration_ms / (60 * 1000), 0.999) as p999
from dataprep_firmware.qr_code_ir_led_disabled_on_trip_duration as a
