...
select
  a.date,
  percentile_approx(signed_in_ms / trip_ms, 0.5) as median,
  percentile_approx(signed_in_ms / trip_ms, 0.10) as p10,
  percentile_approx(signed_in_ms / trip_ms, 0.01) as p1,
  percentile_approx(signed_in_ms / trip_ms, 0.001) as p01
from dataprep_firmware.sign_in_uptime as a
