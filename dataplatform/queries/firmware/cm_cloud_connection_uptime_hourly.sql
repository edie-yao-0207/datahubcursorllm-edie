...
select
  a.date,
  percentile_approx(connection_total_ms/total_ms, 0.5) as median,
  percentile_approx(connection_total_ms/total_ms, 0.1) as p10,
  percentile_approx(connection_total_ms/total_ms, 0.01) as p1,
  percentile_approx(connection_total_ms/total_ms, 0.001) as p01
from dataprep_firmware.cm_device_hourly_cloud_connection as a
join daily_cohort as b
  on to_date(a.date) = b.date
