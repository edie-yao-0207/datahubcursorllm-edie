...
select
	a.date,
	a.day_phase,
	percentile_approx(latency_ms / (60 * 1000), 0.5) as median,
  percentile_approx(latency_ms / (60 * 1000), 0.90) as p90,
	percentile_approx(latency_ms  / (60 * 1000), 0.99) as p99,
	percentile_approx(latency_ms / (60 * 1000), 0.999) as p999
from dataprep_firmware.qr_code_scan_attempt_latency as a
