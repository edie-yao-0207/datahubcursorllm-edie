...
select
	a.date,
	percentile_approx(latency_ms / 1000, 0.5) as median,
    percentile_approx(latency_ms / 1000, 0.90) as p90,
	percentile_approx(latency_ms / 1000, 0.99) as p99,
	percentile_approx(latency_ms / 1000, 0.999) as p999
