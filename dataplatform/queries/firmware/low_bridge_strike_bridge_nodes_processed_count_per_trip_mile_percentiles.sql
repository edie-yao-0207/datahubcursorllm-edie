...
create or replace temp view count_per_device_per_trip_mile as (
  select
    b.date,
    b.org_id,
    b.device_id,
  ...
  from
    dataprep_firmware.low_bridge_strike_bridge_nodes_processed_count as a
    right join filtered_devices as b
      on a.date = b.date
      and a.org_id = b.org_id
      and a.device_id = b.device_id
  where b.trip_miles > 0
  group by
    b.date,
    b.org_id,
    b.device_id,
