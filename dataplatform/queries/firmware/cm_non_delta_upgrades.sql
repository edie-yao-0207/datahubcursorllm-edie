...
select
  a.date,
  percentile_approx(successful_full_upgrades_count, 0.5) as median,
  percentile_approx(successful_full_upgrades_count, 0.9) as p90,
  percentile_approx(successful_full_upgrades_count, 0.99) as p99,
  percentile_approx(successful_full_upgrades_count, 0.999) as p999
from dataprep_firmware.cm_device_daily_full_upgrades as a
