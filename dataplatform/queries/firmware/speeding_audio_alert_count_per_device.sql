...
-- Filtered devices with audio alerts enabled
...
-- Count of devices
create or replace temp view device_count as (
  select
    date,
...
-- Calculate count per device
select
  a.date,
  b.count / a.device_count as count_per_device
from
  device_count as a
