...
select
  b.date,
  mean(ways_away_from_bridge_way) as avg,
  percentile_approx(ways_away_from_bridge_way, 0.01) as p01,
  percentile_approx(ways_away_from_bridge_way, 0.1) as p10,
  percentile_approx(ways_away_from_bridge_way, 0.25) as p25,
  percentile_approx(ways_away_from_bridge_way, 0.5) as median,
  percentile_approx(ways_away_from_bridge_way, 0.75) as p75,
  percentile_approx(ways_away_from_bridge_way, 0.90) as p90,
  percentile_approx(ways_away_from_bridge_way, 0.99) as p99
