...
select
  a.date,
  percentile_approx(upgrade_download_failure_count, 0.5) as median,
  percentile_approx(upgrade_download_failure_count, 0.90) as p90,
  percentile_approx(upgrade_download_failure_count, 0.99) as p99,
  percentile_approx(upgrade_download_failure_count, 0.999) as p999
from dataprep_firmware.cm_device_daily_upgrade_failures as a
