...
select
	a.date,
	percentile_approx(scan_ms / powered_ms, 0.5) as median,
    percentile_approx(scan_ms / powered_ms, 0.1) as p10,
	percentile_approx(scan_ms / powered_ms, 0.01) as p1,
	percentile_approx(scan_ms / powered_ms, 0.001) as p01
from dataprep_firmware.qr_code_scan_uptime as a
