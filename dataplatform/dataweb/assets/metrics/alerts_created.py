...
@metric(
    description="(Regional) Created alert configs",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT alert_config_uuid)",
            "metadata": {
                "comment": """The total number of alert configs that were created"""
            },
        },
    ],
    dimensions=[
        ...
        },
        {
            "name": "is_admin",
            "metadata": {
                "comment": "If true, alert is not visible to customers"
            },
        },
        {
            "name": "internal_type",
        ...
        },
        {
            ...
            "metadata": {
                "comment": "Primary trigger type of alert"
            },
        },
        {
            "name": "secondary_trigger_type",
            "metadata": {
                "comment": "Secondary trigger type of alert"
            },
        },
        {
            "name": "alert_action_type",
            "metadata": {
                "comment": "Action type taken in response to alert"
            },
        },
        {
            "name": "alert_recipient_type",
            "metadata": {
                "comment": "Type of recipients targeted by alert"
            },
        },
        {
            "name": "alert_notification_type",
            "metadata": {
                "comment": "Type of notification handled by alert"
            },
        },
    ],
    ...
    upstreams=[
        AssetKey([Database.DATAMODEL_PLATFORM, "dim_alert_configs"]),
...
def alerts_created(context: AssetExecutionContext) -> str:
