...
@metric(
    description="(Global) The total number of customer accounts with at least one online device.",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT sam_number)",
            "metadata": {
                "comment": "The total number of customer accounts with at least one online device."
            },
        }
    ],
    dimensions=[
...
def customer_accounts(context: AssetExecutionContext) -> str:
