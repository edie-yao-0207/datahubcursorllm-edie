...
@metric(
    description="(Global) The number of customers with Safety event review ratings.",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(id)",
            "metadata": {
                "comment": "The number of customers with Safety event review ratings."
            },
        }
    ],
    dimensions=[
        ...
        },
        {
            "name": "is_useful",
            "metadata": {
                "comment": "A flag indicating whether a safety event review was useful (thumbsup/thumbs)."
            },
        },
        {
            "name": "is_safety_event_review",
            "metadata": {
                "comment": "A flag indicating whether the rating is from a safety event review."
            },
        },
        {
            "name": "avg_mileage",
    ...
    upstreams=[
        AssetKey([Database.DATAENGINEERING, "safety_event_surveys_global"]),
...
def safety_event_ratings(context: AssetExecutionContext) -> str:
