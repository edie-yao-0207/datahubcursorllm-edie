...
@metric(
    description="(Regional) The average row failure rate for CSV uploads",
    expressions=[
        {
            "expression_type": "avg",
            "expression": "AVG(row_error_rate)",
            "metadata": {
                "comment": "The average row failure rate for CSV uploads"
            },
        },
    ],
    dimensions=[
...
def csv_upload_row_failures(context: AssetExecutionContext) -> str:
