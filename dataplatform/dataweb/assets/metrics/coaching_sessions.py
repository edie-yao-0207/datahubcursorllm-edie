...
@metric(
    description="(Global) The number of started coaching sessions",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(CONCAT(id, '_', session_started_time))",
            "metadata": {
                "comment": "The number of started coaching sessions"
            },
        }
    ],
    dimensions=[
...
def coaching_sessions(context: AssetExecutionContext) -> str:
