...
@metric(
    description="(Regional) Total number of drivers who submitted a DVIR",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT driver_id)",
            "metadata": {
                "comment": "The total number of drivers who submitted a DVIR"
            },
        },
    ],
    dimensions=[
        ...
        },
        {
            "name": "is_internal",
            "metadata": {
                "comment": "Whether DVIR was submitted by an internal user or not"
            },
        },
        {
            "name": "avg_mileage",
    ...
    upstreams=[
        AssetKey([Database.DATAMODEL_TELEMATICS, "fct_dvirs"]),
...
def dvir_drivers(context: AssetExecutionContext) -> str:
