...
@metric(
    description="(Global) The percentage of trips with assigned drivers.",
    expressions=[
        {
            "expression_type": "percent",
            "expression": "SUM(is_driver_assigned) * 1.0 / COUNT(*)",
            "metadata": {
                "comment": "The percentage of trips with assigned drivers."
            },
        }
    ],
    dimensions=[
...
def trips_assigned(context: AssetExecutionContext) -> str:
