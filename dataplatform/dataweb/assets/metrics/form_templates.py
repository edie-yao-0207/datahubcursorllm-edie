...
@metric(
    description="(Regional) Tracks created form/workflow templates",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(uuid)",
            "metadata": {
                "comment": "The number of created form templates"
            },
        },
    ],
    dimensions=[
        {
            "name": "date",
            "metadata": {
                "comment": "The calendar date when the form template was created in YYYY-mm-dd format"
            },
        },
        {
            "name": "org_id",
        ...
        },
        {
            "name": "title",
            "metadata": {
                "comment": "Title of form"
            },
        },
        {
            "name": "product_type",
            "metadata": {
                "comment": "Product type associated with form template"
            },
        },
        {
            "name": "avg_mileage",
    ...
    upstreams=[
        AssetKey(["formsdb_shards", "form_templates"]),
...
def form_templates(context: AssetExecutionContext) -> str:
