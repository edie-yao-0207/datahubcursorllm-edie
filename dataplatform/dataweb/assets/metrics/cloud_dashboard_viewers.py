...
@metric(
    description="(Global) The number of users accessing various pages in the Cloud dashboard",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT user_id)",
            "metadata": {
                "comment": "The number of unique users who have accessed a page in the Cloud dashboard"
            },
        }
    ],
    dimensions=[
        ...
        },
        {
            "name": "user_id",
            "metadata": {
                "comment": "User ID accessing dashboard"
            },
        },
        {
            "name": "user_email",
            "metadata": {
                "comment": "Email corresponding to User accessing dashboard"
            },
        },
        {
            "name": "is_customer_email",
            "metadata": {
                "comment": "Whether the email address is from a customer or internal"
            },
        },
        {
        ...
        },
        {
            "name": "routename",
            "metadata": {
                "comment": "Route name of web page being viewed"
            },
        },
        {
            "name": "internal_type",
    ...
    upstreams=[
        AssetKey([Database.DATAMODEL_PLATFORM_SILVER, "stg_cloud_routes"]),
...
def cloud_dashboard_viewers(context: AssetExecutionContext) -> str:
