    ...
    expressions=[
        {
            ...
            "expression": "COUNT(DISTINCT device_id) FILTER(WHERE is_device_online = 1)",
            "metadata": {
                "comment": "The total number of customer devices with at least one heartbeat."
            },
        },
        {
            "expression_type": "percent",
            "expression": "SUM(is_device_online) * 1.0 / COUNT(is_device_online)",
            "metadata": {
                "comment": "The percentage of devices that are online with at least one heartbeat."
            },
        },
    ],
    dimensions=[
...
def devices_online(context: AssetExecutionContext) -> str:
