...
@metric(
    description="(Global) The number of users with at least one coaching session.",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT id)",
            "metadata": {
                "comment": "The number of users with at least one coaching session."
            },
        }
    ],
    dimensions=[
...
def users_coaching_sessions(context: AssetExecutionContext) -> str:
