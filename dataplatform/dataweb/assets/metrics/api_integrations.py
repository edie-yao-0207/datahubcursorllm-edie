...
@metric(
    description="All API Integrations installed by an org",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT CONCAT(type, '_', token_id))",
            "metadata": {
                "comment": "The total number of installed API Integrations"
            },
        },
    ],
    dimensions=[
...
def api_integrations(context: AssetExecutionContext) -> str:
