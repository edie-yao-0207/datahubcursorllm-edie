...
@metric(
    description="(Regional) SoS signals from Worker Safety",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT sossignaluuid)",
            "metadata": {
                "comment": "The count of unique SOS signals from Worker Safety"
            },
        },
    ],
    dimensions=[
        ...
        },
        {
            "name": "user_id",
            "metadata": {
                "comment": "User ID of worker with signal"
            },
        },
        {
            "name": "is_internal",
        ...
        },
        {
            "name": "platform",
            "metadata": {
                "comment": "Platform of mobile device used by driver"
            },
        },
        {
            "name": "os_version",
            "metadata": {
                "comment": "OS version used by driver"
            },
        },
        {
            "name": "avg_mileage",
