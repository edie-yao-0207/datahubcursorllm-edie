...
@metric(
    description="(Global) The total number of trips from VG devices.",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(trip_id)",
            "metadata": {
                "comment": "The total number of trips from VG devices."
            },
        }
    ],
    dimensions=[
...
def vehicle_gateway_trips(context: AssetExecutionContext) -> str:
