    ...
    expressions=[
        {
            ...
            "metadata": {
                "comment": "The number of customers with Safety event reviews."
            },
        }
    ],
    dimensions=[
        ...
        {
            "name": "has_review_completed",
            "metadata": {
                "comment": "A flag indicating whether a safety event review was completed by a customer."
            },
        },
        {
            "name": "avg_mileage",
...
def customers_with_safety_event_reviews(context: AssetExecutionContext) -> str:
