...
@metric(
    description="(Global) The total number of safety video requests.",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(id)",
            "metadata": {"comment": "The total number of safety video requests."},
        }
    ],
    dimensions=[
        {
...
def safety_video_requests(context: AssetExecutionContext) -> str:
