...
@metric(
    description="(Global) The number of users with safety video retrieval requests.",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT distinct_id)",
            "metadata": {
                "comment": "The number of users with safety video retrieval requests."
            },
        }
    ],
    dimensions=[
        ...
        {
            "name": "is_confirmation_conversion",
            "metadata": {
                "comment": "A flag indicating that the video retrieval request converted to the Confirmation page."
            },
        },
        {
            "name": "is_selection_conversion",
            "metadata": {
                "comment": "A flag indicating that the video retrieval request converted to the Selection page."
            },
        },
        {
            "name": "is_submitted_conversion",
            "metadata": {
                "comment": "A flag indicating that the video retrieval request converted to the Submitted page."
            },
        },
        {
            "name": "avg_mileage",
    ...
    upstreams=[
        AssetKey([Database.DATAENGINEERING, "safety_video_retrievals_global"]),
...
def users_with_video_retrieval_requests(context: AssetExecutionContext) -> str:
