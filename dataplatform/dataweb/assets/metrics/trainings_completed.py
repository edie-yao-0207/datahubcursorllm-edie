...
@metric(
    description="(Regional) Tracks the number of completed trainings",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(CASE WHEN status = 1 THEN uuid END)",
            "metadata": {
                "comment": "The number of completed trainings"
            },
        },
        {
            ...
            "metadata": {
                "comment": "The percent of completed trainings"
            },
        },
    ],
    dimensions=[
        {
            "name": "date",
            "metadata": {
                "comment": "The calendar date when the training was completed in YYYY-mm-dd format"
            },
        },
        {
            "name": "org_id",
...
def trainings_completed(context: AssetExecutionContext) -> str:
