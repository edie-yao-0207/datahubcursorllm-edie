...
@metric(
    description="(Regional) Incidents from Worker Safety",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT incidentuuid)",
            "metadata": {
                "comment": "The count of unique incidents from Worker Safety"
            },
        },
    ],
    dimensions=[
        ...
        },
        {
            "name": "source_type",
            "metadata": {
                "comment": "Source for SoS signal"
            },
        },
        {
            "name": "incident_status",
            "metadata": {
                "comment": "Status of incident (in-progress, resolved, etc.)"
            },
        },
        {
            "name": "incident_priority",
            "metadata": {
                "comment": "Priority of incident (critical, high, medium, low)"
            },
        },
        {
            "name": "assigned_user_id",
            "metadata": {
                "comment": "User ID incident is assigned to"
            },
        },
        {
            "name": "is_internal",
            "metadata": {
                "comment": "Whether assigned user is an internal Samsara user or not"
            },
        },
        {
            "name": "avg_mileage",
