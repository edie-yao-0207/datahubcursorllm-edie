...
@metric(
    description="(Regional) The percent of orgs having a driver with at least one tag",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT CASE WHEN tags_size > 0 THEN org_id END)",
            "metadata": {
                "comment": "The count of orgs having a driver with at least one tag"
            },
        },
        {
            ...
            "metadata": {
                "comment": "The percent of orgs having a driver with at least one tag"
            },
        },
    ],
    dimensions=[
...
def driver_tags_orgs(context: AssetExecutionContext) -> str:
