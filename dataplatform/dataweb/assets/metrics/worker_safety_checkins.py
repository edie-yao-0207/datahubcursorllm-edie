...
@metric(
    description="(Regional) Timer responses from Worker Safety",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT timeruuid)",
            "metadata": {
                "comment": "The count of unique timer responses from Worker Safety"
            },
        },
    ],
    dimensions=[
...
def worker_safety_checkins(context: AssetExecutionContext) -> str:
