...
@metric(
    description="(Global) The percentage of safety video requests that were successful.",
    expressions=[
        {
            "expression_type": "percent",
            "expression": "COUNT(CASE WHEN is_retrieval_successful = 1 THEN id END) * 1.0 / COUNT(id)",
            "metadata": {
                "comment": "The percentage of safety video requests that were successful."
            },
        }
    ],
    dimensions=[
        ...
        },
        {
            ...
            "metadata": {"comment": "The Industry classification of the account."},
        },
        {
    ...
    upstreams=[
        AssetKey([Database.DATAENGINEERING, "video_requests_global"]),
...
def safety_video_requests_successful(context: AssetExecutionContext) -> str:
