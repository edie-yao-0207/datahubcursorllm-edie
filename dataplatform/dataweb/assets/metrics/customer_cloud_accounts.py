...
@metric(
    description="(Global) The total number of customer cloud dashboard accounts. A Samsara customer may have multiple accounts in the cloud dashboard.",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT org_id)",
            "metadata": {
                "comment": "The total number of customer cloud dashboard accounts. A Samsara customer may have multiple accounts in the cloud dashboard."
            },
        }
    ],
    dimensions=[
...
def customer_cloud_accounts(context: AssetExecutionContext) -> str:
