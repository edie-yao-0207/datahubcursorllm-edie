    ...
    expressions=[
        {
            ...
            "metadata": {"comment": "The number of users with Safety Inbox activity."},
        }
    ],
    dimensions=[
        {
        ...
        },
        {
            ...
            "metadata": {
                "comment": "Whether email belongs to a Samsara user or not"
            },
        },
    ],
...
def users_with_safety_inbox_activity(context: AssetExecutionContext) -> str:
