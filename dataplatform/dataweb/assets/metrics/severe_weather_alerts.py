...
@metric(
    description="(Regional) Severe Weather Alerts",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT workflow_incident_id)",
            "metadata": {
                "comment": "The count of unique severe weather alerts"
            },
        },
    ],
    dimensions=[
        ...
        },
        {
            "name": "trigger_uuid",
            "metadata": {
                "comment": "ID of trigger"
            },
        },
        {
            "name": "incident_name",
            "metadata": {
                "comment": "Name of the incident"
            },
        },
    ],
    ...
    upstreams=[
        AssetKey(["workflowsdb_shards", "triggers"]),
...
def severe_weather_alerts(context: AssetExecutionContext) -> str:
