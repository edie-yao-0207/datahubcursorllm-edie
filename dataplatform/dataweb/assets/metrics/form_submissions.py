...
@metric(
    description="(Regional) Tracks completed form submissions",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(CASE WHEN status = 1 THEN uuid END)",
            "metadata": {
                "comment": "The number of completed form submissions"
            },
        },
        {
            ...
            "metadata": {
                "comment": "The percent of completed form submissions"
            },
        },
    ],
    dimensions=[
        {
            "name": "date",
            "metadata": {
                "comment": "The calendar date when the form was submitted in YYYY-mm-dd format"
            },
        },
        {
            "name": "org_id",
        ...
        },
        {
            "name": "is_internal",
            "metadata": {
                "comment": "Whether form is submitted by an internal user or not"
            },
        },
        {
            "name": "avg_mileage",
    ...
    glossary_terms=[GlossaryTerm.FORMS, GlossaryTerm.MPR],
    upstreams=[
...
def form_submissions(context: AssetExecutionContext) -> str:
