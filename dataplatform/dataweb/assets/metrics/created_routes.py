...
@metric(
    description="(Regional) Created routes from fct_dispatch_routes",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT CONCAT(org_id, '_', route_id))",
            "metadata": {
                "comment": "The total number of created routes"
            },
        },
    ],
    dimensions=[
...
def created_routes(context: AssetExecutionContext) -> str:
