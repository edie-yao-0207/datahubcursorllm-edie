...
@metric(
    description="(Regional) Custom courses for training usage",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(uuid)",
            "metadata": {
                "comment": "The number of custom courses created"
            },
        },
    ],
    dimensions=[
        {
            "name": "date",
            "metadata": {
                "comment": "The calendar date when the custom course was created in YYYY-mm-dd format"
            },
        },
        {
            "name": "org_id",
        ...
        },
        {
            "name": "content_type",
            "metadata": {
                "comment": "Whether course was authored or imported"
            },
        },
        {
        ...
        {
            "name": "content_import_status",
            "metadata": {
                "comment": "Status of the custom course"
            },
        },
        {
            "name": "avg_mileage",
        ...
        },
        {
            "name": "is_internal",
            "metadata": {
                "comment": "Whether the course was created by an internal user or not"
            },
        },
    ],
    ...
    upstreams=[
        ...
        AssetKey(["trainingdb_shards", "course_revisions"]),
...
def custom_courses(context: AssetExecutionContext) -> str:
