...
@metric(
    description="(Regional) Tracks the number of completed safety trainings",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(CASE WHEN status = 1 THEN uuid END)",
            "metadata": {
                "comment": "The number of completed safety trainings"
            },
        },
        {
            "expression_type": "percent",
            "expression": "COUNT(CASE WHEN status = 1 THEN uuid END) * 1.0 / COUNT(uuid)",
            "metadata": {
                "comment": "The percent of completed safety trainings"
            },
        },
    ],
    dimensions=[
        {
            "name": "date",
            "metadata": {
                "comment": "The calendar date when the safety training was completed in YYYY-mm-dd format"
            },
        },
        {
            "name": "org_id",
...
def safety_trainings_completed(context: AssetExecutionContext) -> str:
