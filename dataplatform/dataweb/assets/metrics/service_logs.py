...
@metric(
    description="(Regional) Total service logs created",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(DISTINCT id)",
            "metadata": {
                "comment": "The total number of service logs created."
            },
        },
    ],
    dimensions=[
    ...
    upstreams=[
        AssetKey(["clouddb", "vehicle_maintenance_logs"]),
        AssetKey(["clouddb", "groups"]),
...
def service_logs(context: AssetExecutionContext) -> str:
