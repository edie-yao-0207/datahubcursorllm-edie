...
@metric(
    description="(Regional) Tracks the number of assigned trainings",
    expressions=[
        {
            "expression_type": "count",
            "expression": "COUNT(CASE WHEN assigned_at IS NOT NULL THEN uuid END)",
            "metadata": {
                "comment": "The number of assigned trainings"
            },
        },
        {
            ...
            "metadata": {
                "comment": "The percent of assigned trainings"
            },
        },
    ],
    dimensions=[
        ...
        },
        {
            "name": "is_internal",
            "metadata": {
                "comment": "Whether the training is assigned to an internal user or not"
            },
        },
    ],
    regions=get_all_regions(),
    owners=[DATAENGINEERING],
    glossary_terms=[GlossaryTerm.TRAINING],
    upstreams=[
...
def trainings_assigned(context: AssetExecutionContext) -> str:
