-- Calculate difference between current and previous cumulative distance on electric power in meters.
SELECT
  DATE(date) AS date,
  org_id,
  object_id,
...
FROM kinesisstats.osDDerivedEvDistanceDrivenOnElectricPowerMeters
