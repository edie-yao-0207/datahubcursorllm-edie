...
cm_2x_3x_recording_intervals_closed AS (
  SELECT
    org_id,
    vg_device_id,
    is_recording,
...
cm_2x_3x_recording_intervals_open AS (
  SELECT
    *
  FROM
...
cm_2x_3x_recording_intervals AS (
  SELECT
    *
  FROM
    cm_2x_3x_recording_intervals_closed
  UNION
  SELECT
    *
  FROM
    cm_2x_3x_recording_intervals_open
),
...
cm_recording_durations AS (
  ...
  FROM
    ...
    LEFT JOIN cm_2x_3x_recording_intervals recordings ON trips.org_id = recordings.org_id
