...
-- This differes versus trip_with_safety_event_labels_v2 in
...
WITH trip_with_safety_events_label AS (
  ...
  FROM
    safety_report.safety_event_labels_v2 labels
    -- safety_report.safety_event_labels_v2.date is base on trip_end_ms
  WHERE
